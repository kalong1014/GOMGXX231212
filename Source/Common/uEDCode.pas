...
interface
  uses Classes, SysUtils{, VMProtectSDK};
...
function EncodeLisence(const Source: String): AnsiString;
function DecodeLisence(const Source: AnsiString): String;
...
function EncodeLisence(const Source: String): AnsiString;
begin
  Result  :=  EncodeString(Source, '8EEFCEC3-3D37-4F02-9132-C378EBT44C97-0228AE12-23CC-410E-9D5C-C8A9ABCDC1D3'+
                                   'F4AF841D-A3E6-4F49-8BD4-D34632A24ECA-4C9DBF5E-FAF6-4A82-9DE5-DA450A8A44A3'+
                                   'BB6EBA67-EFF4-494A-A67B-85A986871B6C-2DA4F723-0342-44A4-ABAF-5378403003A1');
end;

function DecodeLisence(const Source: AnsiString): String;
begin
  Result  :=  DecodeString(Source, '8EEFCEC3-3D37-4F02-9132-C378EBT44C97-0228AE12-23CC-410E-9D5C-C8A9ABCDC1D3'+
                                   'F4AF841D-A3E6-4F49-8BD4-D34632A24ECA-4C9DBF5E-FAF6-4A82-9DE5-DA450A8A44A3'+
                                   'BB6EBA67-EFF4-494A-A67B-85A986871B6C-2DA4F723-0342-44A4-ABAF-5378403003A1');
end;

...
uses
  ...
  Grobal2, AbstractCanvas, AbstractTextures, uGameEngine, ExtCtrls, CliUtil, ClFunc,
  magiceff, Actor, SoundUtil, ClEvent, MShare;
...
type
   ...
   protected
      ...
      DieEffectSurface: TAsphyreLockableTexture;
   ...
   px2, py2 :integer;
   BodySurface2: TAsphyreLockableTexture;
   public
      procedure LoadSurface; override;
      procedure  DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean ); override;
   end;
...
begin
   ...
   case CurrentAction of
      SM_TURN:
         begin            if Race in [93,100] then SitDown := False; // 환영한호, 이무기
...
procedure  TSkeletonOma.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
var
   idx: integer;
   d: TAsphyreCanvas;
   ceff: TColorEffect;
begin
   ...
   if GetTickCount - loadsurfacetime > (FREE_TEXTURE_TIME div 2) then begin
      loadsurfacetime := GetTickCount;
...
procedure  TCatMon.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
var
   idx: integer;
   d: TAsphyreCanvas;
   ceff: TColorEffect;
...
procedure  TGasKuDeGi.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
var
   idx: integer;
   d: TAsphyreCanvas;
   ceff: TColorEffect;
...
procedure  TAngel.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
var
   nx, ny : integer;
   ceff: TColorEffect;
begin
   ...
   if (BodySurface <> nil) and (BodySurface2 <> nil) then begin
      dsurface.DrawBlend(dx + px + ShiftX, dy + py + ShiftY,BodySurface,1);
...
procedure TJumaThunderMon.DrawEff (dsurface: TAsphyreCanvas; dx, dy: integer);
var
   idx: integer;
   d: TAsphyreCanvas;
   ceff: TColorEffect;

...
uses
  ...
  Grobal2, AbstractCanvas, AbstractTextures, uGameEngine, CliUtil, magiceff,
  Actor, WIl, MShare;
...
procedure  TMineMon.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
...
procedure TCentipedeKingMon.DrawEff (dsurface: TAsphyreCanvas; dx, dy: integer);
var
   idx: integer;
...
procedure  TCastleDoor.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
begin
...
procedure  TWallStructure.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
begin
   inherited DrawChr (dsurface, dx, dy, blend, WingDraw);
...
procedure  TDragonBody.DrawChr (dsurface: TAsphyreCanvas; dx, dy: integer; blend: Boolean; WingDraw: Boolean );
var
   idx, ax, ay: integer;
   d: TAsphyreLockableTexture;
   ceff: TColorEffect;

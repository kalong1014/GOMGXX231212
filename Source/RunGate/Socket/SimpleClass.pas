...
function StrToIntEx(const str: PAnsiChar; Len: Integer): Integer; overload;
function StrToIntEx(const str: PAnsiChar): Integer; overload;

function IntToStrEx(Value: Integer; const Buf: PAnsiChar): PAnsiChar;
function IntToStrLEx(Value: Integer; const Buf: PAnsiChar): Integer;
...
begin
  ...
  begin
    ...
    begin
      raise EStrToInt.CreateFmt(ECFNotIntChar, [PAnsiChar(PBin)^]);
...
function Int64ToStrEx(Value: Int64; const Buf: PAnsiChar): PAnsiChar;
asm
        PUSH    ESI
        MOV     ESI, EDX

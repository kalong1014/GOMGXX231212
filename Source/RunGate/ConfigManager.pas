...
begin
  ...
  m_szDenyPresendMsg := '[提示]:本服务器已经关闭商城';
...
begin
  ...
  m_szDenyPresendMsg := ReadString('Strings', 'DenyPresendMsg', m_szDenyPresendMsg);
  ...
  with m_xIni do begin
    case nType of
      ...
      1: begin
          ...
          WriteString('Strings', 'DenyPresendMsg', m_szDenyPresendMsg);

...
var
  ...
  CS_CharNameFilter         : TRTLCriticalSection;
  ...
  FilterCharNameList        : TStringList;
...
//procedure LoadCharNameFilterFile();
implementation
...
begin
  ...
  for i := 0 to sList.Count - 1 do begin
    if sList[i] = '' then
      Continue;
    nIP := inet_addr(PAnsiChar(sList[i]));
...
begin
  ...
  for i := 0 to sList.Count - 1 do begin
    ...
    dwIPLow := Misc.ReverseIP(inet_addr(PAnsiChar(szIPLow)));
    dwIPHigh := Misc.ReverseIP(inet_addr(PAnsiChar(szIPHigh)));
...
//  sFileName                 : string;
//begin
//  //MainOutMessage('正在角色字符过滤配置信息...', 4);
//  sFileName := '.\CharNameFilter.txt';
//  if FileExists(sFileName) then begin
////    CS_CharNameFilter.Enter;
//     EnterCriticalSection(CS_CharNameFilter);
//    try
//      FilterCharNameList.LoadFromFile(sFileName);
//    finally
////      CS_CharNameFilter.Leave;
//      LeaveCriticalSection(CS_CharNameFilter);
//    end;
//  end else begin
//    EnterCriticalSection(CS_CharNameFilter);
//    try
//      FilterCharNameList.Add('僵');
//      FilterCharNameList.Add('尸');
//      FilterCharNameList.SaveToFile(sFileName);
//    finally
//      LeaveCriticalSection(CS_CharNameFilter);
//    end;
//  end;
////  MainOutMessage('角色字符过滤信息加载完成...', 4);
//end;

initialization
  InitializeCriticalSection(g_ConnectOfIPLock);
  InitializeCriticalSection(g_NewIDOfIPLock);
  InitializeCriticalSection(CS_CharNameFilter);
  ...
  FilterCharNameList := TStringList.Create;

...
uses
  ...
  HUtil32, ObjBase, Grobal2, Envir, M2Share;
...
type
   TEvent = class
      ...
      EventType: integer;
      EventParam: integer;
      OpenStartTime: longword;   //ø≠∏∞Ω√∞£
      ContinueTime: longword;         //ø≠ø©¿÷¿ª Ω√∞£
      CloseTime: longword;
      Closed: Boolean;
      Damage: integer;
      OwnCret: TCreature;
   ...
   TPileStones = class (TEvent) //µππ´¥ı±‚(ƒµ »Á¿˚)
   public
      constructor Create (penv: TEnvirnoment; ax, ay, etype, etime: integer; bovisible: Boolean);
  ...
  public
    ...
    TYinYangEvent = class(TEvent) //“ı—ÙŒÂ––’Û
  private
    ticktime: longword;
  public
    constructor Create(user: TCreature; ax, ay, etype, etime, dam: integer);

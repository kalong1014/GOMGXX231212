...
begin
  ...
  chksigedu.Checked := g_bochksigedu;
   //跑步禁止穿
  CheckBoxDisHumRun.Checked := g_boDiableHumanRun;
  CheckBoxRunHum.Checked := g_boRUNHUMAN;
  CheckBoxRunMon.Checked := g_boRUNMON;
  CheckBoxRunNpc.Checked := g_boRunNpc;
  CheckBoxRunGuard.Checked := g_boRunGuard;
  CheckBoxWarDisHumRun.Checked := g_boWarDisHumRun;
  CheckBoxGMRunAll.Checked := g_boGMRunAll;
  CheckBoxSafeArea.Checked := g_boSafeAreaLimited;
  ...
  begin
    ...
    g_boDiableHumanRun := CheckBoxDisHumRun.Checked;
    g_boRUNHUMAN := CheckBoxRunHum.Checked;
    g_boRUNMON := CheckBoxRunMon.Checked;
    g_boRunNpc := CheckBoxRunNpc.Checked;
    g_boRunGuard := CheckBoxRunGuard.Checked;
    g_boWarDisHumRun := CheckBoxWarDisHumRun.Checked;
    g_boGMRunAll := CheckBoxGMRunAll.Checked;
    g_boSafeAreaLimited := CheckBoxSafeArea.Checked;
...
begin
  if  CheckBoxDisHumRun.Checked then
  begin

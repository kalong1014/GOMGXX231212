...
uses
  ...
  EwbCore, EmbeddedWB, uEDCode, StrUtils, IniFiles,
  cxGraphics, cxControls, cxLookAndFeels, cxCheckBox, GDIPicture,
  cxLookAndFeelPainters, cxStyles, cxEdit, cxInplaceContainer, cxVGrid, cxHOI,
  cxColorComboBox, W7ProgressBars, M2LoginEmbFiles, ActiveX, uTypes, M2RTTIInspector,
  dxSkinsCore, dxSkinsdxBarPainter, dxSkinsdxDockControlPainter,
  dxSkinsdxStatusBarPainter, cxContainer, cxProgressBar, dxStatusBar,Zlib,
  dxSkinOffice2016Colorful, dxSkinOffice2016Dark, dxSkinVisualStudio2013Blue,
  dxSkinVisualStudio2013Dark, dxSkinVisualStudio2013Light, dxSkinOffice2019Colorful, dxSkinTheBezier, System.ImageList,
...
implementation
  uses M2Validate, M2GDIPictureEd, Grobal2,M2LoginServerList;
  ...
  begin
    ...
    begin
      try
        ...
        begin
          FillChar(ExeStructure, SizeOf(TuExecutableStructure), #0);
          ExeRes :=  TResourceStream.Create(HInstance, 'CLI_LOGIN_EXE', RT_RCDATA);

object frmPacketRule: TfrmPacketRule
  ...
  object pcProcessPack: TPageControl
    ...
    object TabSheet3: TTabSheet
      ...
      object Label6: TLabel
        ...
        Width = 102
        Height = 12
        Caption = #27880#20876#36134#21495#36807#28388#21015#34920':'
      end
      ...
      object cbCheckEnableIDService: TCheckBox
        Tag = 130
        Left = 15
        Top = 71
        Width = 121
        Height = 17
        Caption = #21551#29992#36134#21495#26381#21153
        TabOrder = 2
        OnClick = cbAllowGetBackChrClick
      end
      object cbCheckNoThisSqlServer: TCheckBox
        Tag = 131
        Left = 118
        Top = 72
        Width = 106
      ...
      object GroupBox3: TGroupBox
        ...
        object EditSqlServer: TEdit
          Left = 73
          Top = 23
          Width = 116
          Height = 20
          TabOrder = 0
          OnChange = EditSqlServerChange
        end
      ...
      object ListBoxBlockIDList: TListBox
        Left = 255
        Top = 23
        Width = 154
        Height = 256
        ...
        ItemHeight = 12
        ParentShowHint = False
        PopupMenu = BlockIDListPopupMenu
        ShowHint = True
        Sorted = True
        TabOrder = 5
      end
      object cbCheckRegisterUser: TCheckBox
        Tag = 132
        Left = 16
        Top = 95
        Width = 113
        Height = 17
        Caption = #20801#35768#27880#20876#29992#25143
        TabOrder = 6
        OnClick = cbAllowGetBackChrClick
      end
      object cbCheckModifyPassword: TCheckBox
        Tag = 133
        Left = 118
        Top = 95
        Width = 97
  ...
  object BlockIDListPopupMenu: TPopupMenu
    OnPopup = BlockListPopupMenuPopup
    Left = 360
    Top = 320
    object IPOPMENU_REFLIST: TMenuItem
      Caption = #21047#26032'(&R)'
      OnClick = IPOPMENU_REFLISTClick
    end
    object IPOPMENU_SORT: TMenuItem
      Caption = #25490#24207'(&S)'
      OnClick = IPOPMENU_SORTClick
    end
    object MenuItem3: TMenuItem
      Caption = '-'
    end
    object IPOPMENU_ADD: TMenuItem
      Caption = #22686#21152'(&A)'
      OnClick = IPOPMENU_ADDClick
    end
    object IPOPMENU_DELETE: TMenuItem
      Caption = #21024#38500'(&D)'
      OnClick = IPOPMENU_DELETEClick
    end
    object IPOPMENU_DELETE_ALL: TMenuItem
      Caption = #20840#37096#21024#38500'(&C)'
      OnClick = IPOPMENU_DELETE_ALLClick
    end
  end
end

...
begin
  ...
  try
    ...
    if IPAddrFilter.IsBlockIP(pRemoteSockaddr.sin_addr.S_addr) then begin
      if g_pLogMgr.CheckLevel(5) then
    ...
    if IPAddrFilter.IsBlockIPArea(pRemoteSockaddr.sin_addr.S_addr) then begin
      if g_pLogMgr.CheckLevel(5) then
    ...
    if IPAddrFilter.OverConnectOfIP(pRemoteSockaddr.sin_addr.S_addr) then begin
      if g_pLogMgr.CheckLevel(5) then

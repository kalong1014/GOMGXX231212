...
const
  ...
  _STR_BLOCK_ID_FILE        = '.\BlockIDList.txt';
...
//  g_DCP_mars                : TDCP_mars;
  ...
  g_pszEndePtr              : PAnsiChar;
  g_pszEndeBuffer           : array[0..MAX_CLIENT_FUNC_SIZE - 1] of AnsiChar;
  g_pLTCrc                  : PInteger;
  g_pszDecodeKey            : PAnsiString;

  g_Rs                      : OleVariant;
  g_Conn                    : OleVariant;
  g_fSQLReady               : Boolean = False;

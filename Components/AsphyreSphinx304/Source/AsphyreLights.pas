unit AsphyreLights;
//---------------------------------------------------------------------------
// AsphyreLights.pas                                    Modified: 14-Sep-2012
// Asphyre 3D abstract light declaration.                        Version 1.02
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
const
 LightWhiteColor: TAsphyreColor = (r: 1.0; g: 1.0; b: 1.0; a: 0.0);
 LightBlackColor: TAsphyreColor = (r: 0.0; g: 0.0; b: 0.0; a: 0.0);
...
begin
 ...
 if (Assigned(Lights[Index])) then FreeAndNil(Lights[Index]);
...
begin
 for i:= Length(Lights) - 1 downto 0 do
  if (Assigned(Lights[i])) then FreeAndNil(Lights[i]);

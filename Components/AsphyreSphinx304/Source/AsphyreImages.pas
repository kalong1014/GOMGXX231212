unit AsphyreImages;
//---------------------------------------------------------------------------
// AsphyreImages.pas                                    Modified: 14-Sep-2012
// Asphyre Images class.                                         Version 2.29
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Types, Classes, AsphyreDef, Vectors2px, AsphyreTypes, AsphyreArchives,
 AbstractTextures;
  ...
  { Adds a new image to the list and loads its data from the specified
    ...
    and the conversion will be done automatically.
     @param(FileName The name of the file to load the image from. The image
      is loaded using functions from @code(AsphyreBitmaps.pas), so to support
...
//---------------------------------------------------------------------------
uses
 SysUtils, AsphyreUtils, StreamUtils, UniStringUtils, AsphyreConv,
 AsphyreFactory, AsphyreEventTypes, AsphyreEvents, MediaUtils, AsphyreAuth,
 SystemSurfaces, AsphyreBitmaps, MediaImages;

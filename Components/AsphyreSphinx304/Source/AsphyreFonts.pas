unit AsphyreFonts;
//---------------------------------------------------------------------------
// AsphyreFonts.pas                                     Modified: 14-Sep-2012
// Asphyre bitmap fonts with unicode support.                     Version 2.1
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Types, Classes, Math, AsphyreDef, Vectors2px, Vectors2, HelperSets,
 AsphyreTypes, AsphyreXML, AsphyreImages, AbstractCanvas, FontLetterGroups;
...
//---------------------------------------------------------------------------
uses
 SysUtils, AsphyreUtils, AsphyreEventTypes, AsphyreEvents, MediaFonts,
 UniStringUtils, MediaUtils, PixelUtils;
 ...
 while (WordNo < Length(Words)) do
  begin
   ...
   for Index:= WordNo to WordNo + NoWords - 1 do
    begin
     DisplayText(Point2(CurPos.x + Round(PosAdd), CurPos.y), Words[Index].Text,
      Alpha);

unit AsphyreTiming;
//---------------------------------------------------------------------------
// AsphyreTiming.pas                                    Modified: 14-Sep-2012
// Cross-platform timing and utilities.                          Version 1.03
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is AsphyreTiming.pas.
//
...
begin
 ...
 {$ifdef Posix}
 if (FMode = atmNotStarted) then FMode:= atmHighPrecision;

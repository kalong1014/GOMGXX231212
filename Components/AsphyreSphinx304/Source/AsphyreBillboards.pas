...
//---------------------------------------------------------------------------
// AsphyreBillboards.pas                                Modified: 14-Sep-2012
// Cross-platform 3D billboard rendering for Asphyre.            Version 1.03
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Types, Vectors2, Vectors3, Vectors4, Matrices4, AsphyreTypes,
...
type
 ...
 public
  ...
  procedure TexMap(const Position: TVector3; const Size: TPoint2;
   Phi: Single; Color: Cardinal);
...
//---------------------------------------------------------------------------
procedure TAsphyreBillboards.UseImagePt(Image: TAsphyreImage;
 Pattern: Integer);
var
 Mapping  : TPoint4;
 TextureNo: Integer;
begin
 TextureNo:= -1;
 if (Assigned(Image)) then TextureNo:= Image.RetrieveTex(Pattern, Mapping);
...
//---------------------------------------------------------------------------
procedure TAsphyreBillboards.UseImagePt(Image: TAsphyreImage;
 Pattern: Integer; const SrcRect: TRect; Mirror, Flip: Boolean);
var
 Mapping  : TPoint4;
 TextureNo: Integer;
begin
...
procedure TAsphyreBillboards.TexMap(const Position: TVector3;
 const Size: TPoint2; Phi: Single; Color: Cardinal);
var
...
begin
 ...
 FVertices.Add(Vector4(Position));
end;

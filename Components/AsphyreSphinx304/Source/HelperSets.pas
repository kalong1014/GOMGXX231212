unit HelperSets;
//---------------------------------------------------------------------------
// HelperSets.pas                                       Modified: 14-Sep-2012
// Helper classes to aid the development of application logic.   Version 1.09
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Types, Classes, AsphyreDef, Vectors2px;
...
{ A list of 32-bit signed integers with many functions that include ordering,
 ...
 public
  ...
  procedure InsertRepeatValue(Value: Integer; ValCount: Integer);
  ...
  procedure DefineValueAtIndex(Index: Integer; Value: Integer);
...
{@exclude}
 ...
 public
  ...
  constructor Create(List: TRectList);
 end;
...
{ List of probabilistic numbers, where individual pairs of numbers and their
 ...
 public
  ...
  function Insert(AValue: Integer;
   Prob: Single = 1.0): Integer;
...
//---------------------------------------------------------------------------
uses
 SysUtils, Math, AsphyreUtils, StreamUtils;
...
//---------------------------------------------------------------------------
procedure TIntegerList.Request(Quantity: Integer);
var
 Required: Integer;
begin
...
//---------------------------------------------------------------------------
procedure TPointList.Request(Quantity: Integer);
var
 Required: Integer;
begin
 Required:= Ceil(Quantity / CacheSize) * CacheSize;
...
//---------------------------------------------------------------------------
constructor TRectListEnumerator.Create(List: TRectList);
begin
 inherited Create();
...
//---------------------------------------------------------------------------
procedure TRectList.Request(Quantity: Integer);
var
 Required: Integer;
begin
 Required:= Ceil(Quantity / CacheSize) * CacheSize;
...
//---------------------------------------------------------------------------
procedure TIntProbList.Request(Quantity: Integer);
var
 Required: Integer;
begin
 Required:= Ceil(Quantity / CacheSize) * CacheSize;

unit AsphyreMD5;
//---------------------------------------------------------------------------
// AsphyreMD5.pas                                       Modified: 14-Sep-2012
// MD5 Message-Digest Algorithm                                  Version 1.01
//---------------------------------------------------------------------------
// This unit was originally written by Matthias Fichtner, 1999 and has been
// adapted by Yuriy Kotsarenko to be compatible with the rest of the library.
//
...
//---------------------------------------------------------------------------
{< Utility routines for calculating MD5 checksums. }
//---------------------------------------------------------------------------
interface
...
//---------------------------------------------------------------------------
type
 {@exclude}MD5Block    = packed array[0..15] of LongWord;
 {@exclude}MD5CBits    = packed array[0..7] of Byte;
 {@exclude}TMD5State   = packed array[0..3] of LongWord;
 {@exclude}TMD5Digest  = packed array[0..15] of Byte;
 {@exclude}TMD5Buffer  = packed array[0..63] of Byte;
 {@exclude}TMD5Context = record
  State : TMD5State;
...
//---------------------------------------------------------------------------
{@exclude}procedure MD5Init(out Context: TMD5Context);
{@exclude}procedure MD5Update(var Context: TMD5Context; Source: Pointer;
 Size: Integer);
{@exclude}procedure MD5Final(var Context: TMD5Context; out Digest: TMD5Digest);

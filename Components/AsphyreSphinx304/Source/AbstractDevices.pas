...
//---------------------------------------------------------------------------
// AbstractDevices.pas                                  Modified: 14-Sep-2012
// Asphyre Device Abstract declaration.                          Version 1.06
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Classes, AsphyreDef, Vectors2px, AbstractTextures, AsphyreSwapChains;
...
{ Hardware device wrapper that handles communication between application and
 ...
 public
  ...
  { Changes size of the back-buffer tied to swap chain identified by the
    ...
    @code(EventDeviceLost) events provided in @code(AsphyreEvents.pas). }
...
//---------------------------------------------------------------------------
uses
 SysUtils, AsphyreEvents, AsphyreTiming;

...
{*                                                                            *}
{*  Modifications by Yuriy Kotsarenko (20-August-2012):                       *}
{*    + Changed file names for distribution with Asphyre framework and avoid  *}
{*      conflicts with other similar headers.                                 *}
{*    + Added dynamic linking at runtime.                                     *}
{*                                                                            *}
{*----------------------------------------------------------------------------*}
{*  $Id: $ }
{******************************************************************************}
...
{$IFDEF DYNAMIC_LINK_ALL}
  {$DEFINE DIRECT3D10_DYNAMIC_LINK}
{$ENDIF}
...
uses
  Windows, AsphyreD3DTypes, AsphyreDXGI;
...
//
///////////////////////////////////////////////////////////////////////////
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CreateDevice = function(pAdapter: IDXGIAdapter;
  DriverType: TD3D10_DriverType; Software: HMODULE; Flags: LongWord;
  SDKVersion: LongWord; out ppDevice: ID3D10Device): HResult; stdcall;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CreateDeviceAndSwapChain = function(pAdapter: IDXGIAdapter;
  DriverType: TD3D10_DriverType; Software: HMODULE; Flags: LongWord;
  SDKVersion: LongWord; pSwapChainDesc: PDXGI_SwapChainDesc;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CreateBlob = function(NumBytes: SIZE_T;
  out ppBuffer: ID3D10Blob): HResult; stdcall;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CompileShader = function(pSrcData: PAnsiChar; SrcDataLen: SIZE_T;
  pFileName: PAnsiChar; const pDefines: PD3D10_ShaderMacro;
  pInclude: ID3D10Include; pFunctionName: PAnsiChar; pProfile: PAnsiChar;
  Flags: LongWord; out ppShader: ID3D10Blob;
  ppErrorMsgs: PID3D10Blob): HRESULT; stdcall;

var
 D3D10CompileShader: TD3D10CompileShader = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10DisassembleShader = function(const pShader: Pointer;
  BytecodeLength: SIZE_T; EnableColorCode: BOOL; pComments: PAnsiChar;
  out ppDisassembly: ID3D10Blob): HRESULT; stdcall;

var
 D3D10DisassembleShader: TD3D10DisassembleShader = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10GetSomeShaderProfile = function(
  const pDevice: ID3D10Device): PAnsiChar; stdcall;

var
 D3D10GetPixelShaderProfile: TD3D10GetSomeShaderProfile = nil;
 D3D10GetVertexShaderProfile: TD3D10GetSomeShaderProfile = nil;
 D3D10GetGeometryShaderProfile: TD3D10GetSomeShaderProfile = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10ReflectShader = function(const pShaderBytecode: Pointer;
  BytecodeLength: SIZE_T;
  out ppReflector: ID3D10ShaderReflection): HRESULT; stdcall;

var
 D3D10ReflectShader: TD3D10ReflectShader = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10PreprocessShader = function(pSrcData: PAnsiChar; SrcDataSize: SIZE_T;
  pFileName: PAnsiChar; const pDefines: PD3D10_ShaderMacro;
  pInclude: ID3D10Include; out ppShaderText: ID3D10Blob;
  ppErrorMsgs: PID3D10Blob): HRESULT; stdcall;

var
 D3D10PreprocessShader: TD3D10PreprocessShader = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10GetSomeSignatureBlob = function(const pShaderBytecode: Pointer;
  BytecodeLength: SIZE_T; out ppSignatureBlob: ID3D10Blob): HRESULT; stdcall;

var
 D3D10GetInputSignatureBlob: TD3D10GetSomeSignatureBlob = nil;
 D3D10GetOutputSignatureBlob: TD3D10GetSomeSignatureBlob = nil;
 D3D10GetInputAndOutputSignatureBlob: TD3D10GetSomeSignatureBlob = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10GetShaderDebugInfo = function(const pShaderBytecode: Pointer;
  BytecodeLength: SIZE_T; out ppDebugInfo: ID3D10Blob): HRESULT; stdcall;

var
 D3D10GetShaderDebugInfo: TD3D10GetShaderDebugInfo = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10StateBlockMaskFunc1 = function(const pA, pB: TD3D10_StateBlockMask;
  out pResult: TD3D10_StateBlockMask): HResult; stdcall;

 TD3D10StateBlockMaskFunc2 = function(var pMask: TD3D10_StateBlockMask;
  StateType: TD3D10_DeviceStateTypes; RangeStart,
  RangeLength: LongWord): HResult; stdcall;

 TD3D10StateBlockMaskFunc3 = function(
  var pMask: TD3D10_StateBlockMask): HResult; stdcall;

 TD3D10StateBlockMaskFunc4 = function(const pMask: TD3D10_StateBlockMask;
  StateType: TD3D10_DeviceStateTypes; Entry: LongWord): BOOL; stdcall;

var
 D3D10StateBlockMaskUnion: TD3D10StateBlockMaskFunc1 = nil;
 D3D10StateBlockMaskIntersect: TD3D10StateBlockMaskFunc1 = nil;
 D3D10StateBlockMaskDifference: TD3D10StateBlockMaskFunc1 = nil;

 D3D10StateBlockMaskEnableCapture: TD3D10StateBlockMaskFunc2 = nil;
 D3D10StateBlockMaskDisableCapture: TD3D10StateBlockMaskFunc2 = nil;

 D3D10StateBlockMaskEnableAll: TD3D10StateBlockMaskFunc3 = nil;
 D3D10StateBlockMaskDisableAll: TD3D10StateBlockMaskFunc3 = nil;

 D3D10StateBlockMaskGetSetting: TD3D10StateBlockMaskFunc4 = nil;

{$ELSE}
function D3D10StateBlockMaskUnion(const pA, pB: TD3D10_StateBlockMask; out pResult: TD3D10_StateBlockMask): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskUnion}
function D3D10StateBlockMaskIntersect(const pA, pB: TD3D10_StateBlockMask; out pResult: TD3D10_StateBlockMask): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskIntersect}
function D3D10StateBlockMaskDifference(const pA, pB: TD3D10_StateBlockMask; out pResult: TD3D10_StateBlockMask): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskDifference}
function D3D10StateBlockMaskEnableCapture(var pMask: TD3D10_StateBlockMask; StateType: TD3D10_DeviceStateTypes; RangeStart, RangeLength: LongWord): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskEnableCapture}
function D3D10StateBlockMaskDisableCapture(var pMask: TD3D10_StateBlockMask; StateType: TD3D10_DeviceStateTypes; RangeStart, RangeLength: LongWord): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskDisableCapture}
function D3D10StateBlockMaskEnableAll(var pMask: TD3D10_StateBlockMask): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskEnableAll}
function D3D10StateBlockMaskDisableAll(var pMask: TD3D10_StateBlockMask): HResult; stdcall; external D3D10dll;
{$EXTERNALSYM D3D10StateBlockMaskDisableAll}
function D3D10StateBlockMaskGetSetting(const pMask: TD3D10_StateBlockMask; StateType: TD3D10_DeviceStateTypes; Entry: LongWord): BOOL; stdcall; external D3D10dll;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CreateStateBlock = function(const pDevice: ID3D10Device;
  const pStateBlockMask: TD3D10_StateBlockMask;
  out ppStateBlock: ID3D10StateBlock): HResult; stdcall;

var
 D3D10CreateStateBlock: TD3D10CreateStateBlock = nil;

{$ELSE}
function D3D10CreateStateBlock(const pDevice: ID3D10Device; const pStateBlockMask: TD3D10_StateBlockMask; out ppStateBlock: ID3D10StateBlock): HResult; stdcall; external D3D10dll;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10CompileEffectFromMemory = function(const pData: Pointer;
  DataLength: SIZE_T; pSrcFileName: PAnsiChar;
  const pDefines: PD3D10_ShaderMacro; const pInclude: ID3D10Include;
  HLSLFlags: LongWord; FXFlags: LongWord; out ppCompiledEffect: ID3D10Blob;
  ppErrors: PID3D10Blob): HResult; stdcall;

 TD3D10CreateEffectFromMemory = function(const pData: Pointer;
  DataLength: SIZE_T; FXFlags: LongWord; const pDevice: ID3D10Device;
  const pEffectPool: ID3D10EffectPool;
  out ppEffect: ID3D10Effect): HResult; stdcall;

 TD3D10CreateEffectPoolFromMemory = function(const pData: Pointer;
  DataLength: SIZE_T; FXFlags: LongWord; const pDevice: ID3D10Device;
  out ppEffectPool: ID3D10EffectPool): HResult; stdcall;

var
 D3D10CompileEffectFromMemory: TD3D10CompileEffectFromMemory = nil;
 D3D10CreateEffectFromMemory: TD3D10CreateEffectFromMemory = nil;
 D3D10CreateEffectPoolFromMemory: TD3D10CreateEffectPoolFromMemory = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
type
 TD3D10DisassembleEffect = function(const pEffect: ID3D10Effect;
  EnableColorCode: BOOL; out ppDisassembly: ID3D10Blob): HResult; stdcall;

var
 D3D10DisassembleEffect: TD3D10DisassembleEffect = nil;
...
{$IFDEF DIRECT3D10_DYNAMIC_LINK}
var
 Direct3D10Lib: THandle = 0;

function Direct3D10Loaded(): Boolean;
begin
 Result:= Direct3D10Lib <> 0;
end;

function UnloadDirect3D10(): Boolean;
begin
 Result:= True;

 if (Direct3D10Loaded()) then
  begin
   Result:= FreeLibrary(Direct3D10Lib);

   D3D10CreateDevice:= nil;
   D3D10CreateDeviceAndSwapChain:= nil;
   D3D10CreateBlob:= nil;
   D3D10CompileShader:= nil;
   D3D10DisassembleShader:= nil;
   D3D10GetPixelShaderProfile:= nil;
   D3D10GetVertexShaderProfile:= nil;
   D3D10GetGeometryShaderProfile:= nil;
   D3D10ReflectShader:= nil;
   D3D10PreprocessShader:= nil;
   D3D10GetInputSignatureBlob:= nil;
   D3D10GetOutputSignatureBlob:= nil;
   D3D10GetInputAndOutputSignatureBlob:= nil;
   D3D10GetShaderDebugInfo:= nil;
   D3D10StateBlockMaskUnion:= nil;
   D3D10StateBlockMaskIntersect:= nil;
   D3D10StateBlockMaskDifference:= nil;
   D3D10StateBlockMaskEnableCapture:= nil;
   D3D10StateBlockMaskDisableCapture:= nil;
   D3D10StateBlockMaskEnableAll:= nil;
   D3D10StateBlockMaskDisableAll:= nil;
   D3D10StateBlockMaskGetSetting:= nil;
   D3D10CreateStateBlock:= nil;
   D3D10CompileEffectFromMemory:= nil;
   D3D10CreateEffectFromMemory:= nil;
   D3D10CreateEffectPoolFromMemory:= nil;
   D3D10DisassembleEffect:= nil;

   Direct3D10Lib:= 0;
  end;
end;

function LoadDirect3D10(): Boolean;
begin
 Result:= Direct3D10Loaded();

 if (not Result) then
  begin
   Direct3D10Lib:= LoadLibrary(D3D10dll);

   if (Direct3D10Loaded()) then
    begin
      LinkDXGI10;
     D3D10CreateDevice:= GetProcAddress(Direct3D10Lib, 'D3D10CreateDevice');
     D3D10CreateDeviceAndSwapChain:= GetProcAddress(Direct3D10Lib, 'D3D10CreateDeviceAndSwapChain');
     D3D10CreateBlob:= GetProcAddress(Direct3D10Lib, 'D3D10CreateBlob');
     D3D10CompileShader:= GetProcAddress(Direct3D10Lib, 'D3D10CompileShader');
     D3D10DisassembleShader:= GetProcAddress(Direct3D10Lib, 'D3D10DisassembleShader');
     D3D10GetPixelShaderProfile:= GetProcAddress(Direct3D10Lib, 'D3D10GetPixelShaderProfile');
     D3D10GetVertexShaderProfile:= GetProcAddress(Direct3D10Lib, 'D3D10GetVertexShaderProfile');
     D3D10GetGeometryShaderProfile:= GetProcAddress(Direct3D10Lib, 'D3D10GetGeometryShaderProfile');
     D3D10ReflectShader:= GetProcAddress(Direct3D10Lib, 'D3D10ReflectShader');
     D3D10PreprocessShader:= GetProcAddress(Direct3D10Lib, 'D3D10PreprocessShader');
     D3D10GetInputSignatureBlob:= GetProcAddress(Direct3D10Lib, 'D3D10GetInputSignatureBlob');
     D3D10GetOutputSignatureBlob:= GetProcAddress(Direct3D10Lib, 'D3D10GetOutputSignatureBlob');
     D3D10GetInputAndOutputSignatureBlob:= GetProcAddress(Direct3D10Lib, 'D3D10GetInputAndOutputSignatureBlob');
     D3D10GetShaderDebugInfo:= GetProcAddress(Direct3D10Lib, 'D3D10GetShaderDebugInfo');
     D3D10StateBlockMaskUnion:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskUnion');
     D3D10StateBlockMaskIntersect:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskIntersect');
     D3D10StateBlockMaskDifference:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskDifference');
     D3D10StateBlockMaskEnableCapture:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskEnableCapture');
     D3D10StateBlockMaskDisableCapture:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskDisableCapture');
     D3D10StateBlockMaskEnableAll:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskEnableAll');
     D3D10StateBlockMaskDisableAll:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskDisableAll');
     D3D10StateBlockMaskGetSetting:= GetProcAddress(Direct3D10Lib, 'D3D10StateBlockMaskGetSetting');
     D3D10CreateStateBlock:= GetProcAddress(Direct3D10Lib, 'D3D10CreateStateBlock');
     D3D10CompileEffectFromMemory:= GetProcAddress(Direct3D10Lib, 'D3D10CompileEffectFromMemory');
     D3D10CreateEffectFromMemory:= GetProcAddress(Direct3D10Lib, 'D3D10CreateEffectFromMemory');
     D3D10CreateEffectPoolFromMemory:= GetProcAddress(Direct3D10Lib, 'D3D10CreateEffectPoolFromMemory');
     D3D10DisassembleEffect:= GetProcAddress(Direct3D10Lib, 'D3D10DisassembleEffect');

     Result:=
      (Assigned(D3D10CreateDevice))and
      (Assigned(D3D10CreateDeviceAndSwapChain))and
      (Assigned(D3D10CreateBlob))and
      (Assigned(D3D10CompileShader))and
      (Assigned(D3D10DisassembleShader))and
      (Assigned(D3D10GetPixelShaderProfile))and
      (Assigned(D3D10GetVertexShaderProfile))and
      (Assigned(D3D10GetGeometryShaderProfile))and
      (Assigned(D3D10ReflectShader))and
      (Assigned(D3D10PreprocessShader))and
      (Assigned(D3D10GetInputSignatureBlob))and
      (Assigned(D3D10GetOutputSignatureBlob))and
      (Assigned(D3D10GetInputAndOutputSignatureBlob))and
      (Assigned(D3D10GetShaderDebugInfo))and
      (Assigned(D3D10StateBlockMaskUnion))and
      (Assigned(D3D10StateBlockMaskIntersect))and
      (Assigned(D3D10StateBlockMaskDifference))and
      (Assigned(D3D10StateBlockMaskEnableCapture))and
      (Assigned(D3D10StateBlockMaskDisableCapture))and
      (Assigned(D3D10StateBlockMaskEnableAll))and
      (Assigned(D3D10StateBlockMaskDisableAll))and
      (Assigned(D3D10StateBlockMaskGetSetting))and
      (Assigned(D3D10CreateStateBlock))and
      (Assigned(D3D10CompileEffectFromMemory))and
      (Assigned(D3D10CreateEffectFromMemory))and
      (Assigned(D3D10CreateEffectPoolFromMemory))and
      (Assigned(D3D10DisassembleEffect));

     if (not Result) then UnloadDirect3D10();
    end;
  end;
end;

...
uses
  Windows, SysUtils, MultiMon, ActiveX, AsphyreD3DTypes;
...
var CreateDXGIFactory: function(const riid:TGUID;out ppFactory: IDXGIFactory {Interface}):HResult; stdcall;
var CreateDXGIFactory1: function(const riid:TGUID;out ppFactory: IDXGIFactory {Interface}):HResult; stdcall;
{$ELSE}
function CreateDXGIFactory(const riid:TGUID;out ppFactory: IDXGIFactory {Interface}):HResult; stdcall; external DXGI_dll;
function CreateDXGIFactory1(const riid:TGUID;out ppFactory: IDXGIFactory {Interface}):HResult; stdcall; external DXGI_dll;
{$ENDIF}
...
function LinkMethod(hDLL:HModule; const MethodName,DLLName:String): Pointer;
begin
...
begin
  {$IFDEF UseRuntimeLinking}
  CreateDXGIFactory:= LinkMethod(hDLL_DXGI, 'CreateDXGIFactory', DXGI_dll);
  CreateDXGIFactory1:= LinkMethod(hDLL_DXGI, 'CreateDXGIFactory1', DXGI_dll);
  {$ENDIF}
end;

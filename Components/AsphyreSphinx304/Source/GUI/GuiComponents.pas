unit GuiComponents;
//---------------------------------------------------------------------------
// GuiComponents.pas                                    Modified: 14-Sep-2012
// Base component class for Asphyre GUI framework.               Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is GuiComponents.pas.
//
...
//---------------------------------------------------------------------------
uses
 Types, Classes, AsphyreDef, Vectors2px, GuiTypes;
...
type
 ...
 protected
  ...
  procedure LoadFieldsFromStream(Stream: TStream);
  procedure SaveFieldsToStream(Stream: TStream);
 public
...
//---------------------------------------------------------------------------
procedure TGuiComponent.SaveFieldsToStream(Stream: TStream);
var
 i, Count: Integer;
 FiName: UniString;
 FiText: UniString;
...
//---------------------------------------------------------------------------
procedure TGuiComponent.LoadFieldsFromStream(Stream: TStream);
var
 i, Count: Integer;
 FiName: UniString;
 FiText: UniString;

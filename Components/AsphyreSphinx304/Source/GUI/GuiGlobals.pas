unit GuiGlobals;
//---------------------------------------------------------------------------
// GuiGlobals.pas                                       Modified: 14-Sep-2012
// Global definitions and utilities for Asphyre GUI framework.          v1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is GuiGlobals.pas.
//
...
//---------------------------------------------------------------------------
uses
 Types, AsphyreDef, Vectors2px, AsphyreTypes, AsphyreImages, AsphyreFonts;
...
//---------------------------------------------------------------------------
uses
 AsphyreUtils, Vectors2, PixelUtils, AbstractCanvas, GuiTypes;

unit GuiScrollBars;
//---------------------------------------------------------------------------
// GuiScrollBars.pas                                    Modified: 14-Sep-2012
// Scroll bar controls for Asphyre GUI framework.                Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is GuiScrollBars.pas.
//
...
//---------------------------------------------------------------------------
uses
 Types, AsphyreDef, Vectors2px, AsphyreTypes, GuiTypes, GuiControls,
 GuiButtons;
...
//---------------------------------------------------------------------------
constructor TGuiScrollBar.Create(AOwner: TGuiControl);
begin
 inherited;

unit GuiTypes;
//---------------------------------------------------------------------------
// GuiTypes.pas                                         Modified: 14-Sep-2012
// General types and variables for Asphyre GUI framework.        Version 1.02
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
// {$ifdef FireMonkey}{$ifdef asphyreios}UITypes,{$else}System.UITypes,{$endif}
// {$else}Windows, Controls,{$endif}
{$if defined(Delphi) and defined(Windows)}
 Windows, {$ifdef FireMonkey}System.UITypes,{$else}Controls,{$endif}
{$ifend}
...
{$endif}
 ...
 Types, Classes, SysUtils, AsphyreDef, Vectors2px, AsphyreTypes,
 AbstractCanvas, AsphyreImages, AsphyreFonts;
...
//---------------------------------------------------------------------------
uses
 Math, AsphyreUtils, PixelUtils, AsphyreBase64;
...
begin
 ...
 if (Length(Source) > MaxSrcSize) then SetLength(Source, MaxSrcSize);

unit GuiCheckBoxes;
//---------------------------------------------------------------------------
// GuiCheckBoxes.pas                                    Modified: 14-Sep-2012
// Check Box controls for Asphyre GUI framework.                 Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is GuiCheckBoxes.pas.
//
...
//---------------------------------------------------------------------------
uses
 Types, Vectors2px, AsphyreDef, GuiTypes, GuiControls;
 ...
 if (not PressedOver) then
  begin
   ...
   if (Event = metUp)and(Button = mbtLeft) then
    begin
     if (ClickedOver)and(MouseOver) then FChecked:= not FChecked;
     ClickedOver:= False;
    end;
  end;
end;

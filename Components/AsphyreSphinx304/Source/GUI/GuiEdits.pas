unit GuiEdits;
//---------------------------------------------------------------------------
// GuiEdits.pas                                         Modified: 14-Sep-2012
// Edit controls for Asphyre GUI framework.                      Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is GuiEdits.pas.
//
...
//---------------------------------------------------------------------------
uses
 {$ifndef FireMonkey}Clipbrd,{$endif} Types, Classes, AsphyreDef, Vectors2px,
 Vectors2, HelperSets, AsphyreTypes, AsphyreFonts, GuiTypes, GuiControls;
...
//---------------------------------------------------------------------------
uses
 SysUtils, AsphyreUtils, AsphyreTiming, GuiGlobals;

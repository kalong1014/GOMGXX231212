...
//---------------------------------------------------------------------------
// AbstractTextures.pas                                 Modified: 14-Sep-2012
// Asphyre Custom Texture implementation.                        Version 1.21
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Types, AsphyreDef, Vectors2px, Vectors2, AsphyreTypes;
...
{ General texture specification, which specifies common parameters and
 ...
 public
  ...
  property ISPNGTexture:Boolean read FISPNGTexture write FISPNGTexture;
...
{ Lockable texture specification where full support is provided for direct
 ...
 public
  ...
  procedure Lock(out Bits: Pointer; out Pitch: Integer); overload; virtual;
...
{ Render target texture specification which supports drawing the entire
 ...
 TAsphyreRenderTargetTexture = class(TAsphyreCustomTexture)      // rtt
 private

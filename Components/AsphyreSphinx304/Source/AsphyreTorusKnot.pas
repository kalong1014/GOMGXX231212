...
//---------------------------------------------------------------------------
// AsphyreTorusKnot.pas                                 Modified: 14-Sep-2012
// Torus PQ Knot implementation for Asphyre.                     Version 1.03
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
uses
 Math, Vectors2, Vectors3, AsphyreMeshes;

//---------------------------------------------------------------------------
procedure CreateTorusKnot(Mesh: TAsphyreMesh; Radius, TubeRadius: Single;
 p, q, Rings, Sides: Integer; TexTilesX, TexTilesY: Single);

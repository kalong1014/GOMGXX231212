unit DX9Devices;
//---------------------------------------------------------------------------
// DX9Devices.pas                                       Modified: 14-Sep-2012
// Direct3D 9 device management for Asphyre.                     Version 1.11
//---------------------------------------------------------------------------
// Important Notice:
//
...
uses
 ...
 Classes, AbstractDevices, AbstractTextures, AsphyreSwapChains, DX9SwapChains;
...
//---------------------------------------------------------------------------
uses
 {$ifdef FireMonkey}FMX.Platform.Win,{$endif}
 SysUtils, DX9Types, AsphyreTypes, AsphyreEvents;
...
begin
 ...
 with D3D9PresentParams do
  begin
   ...
   {$ifdef FireMonkey}
   hDeviceWindow:= FmxHandleToHWND(SwapChain.WindowHandle);
   {$else}

unit OGLTypes;
//---------------------------------------------------------------------------
// OGLTypes.pas                                         Modified: 14-Sep-2012
// OpenGL types and helper utilities.                            Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is OGLTypes.pas.
//
...
// by using render targets.
 OGLUsingFrameBuffer: Boolean = False;

//---------------------------------------------------------------------------
function GetOpenGLTechVersion(): Integer;

//---------------------------------------------------------------------------
function OGLCreateNewTexture(out Texture: GLuint;
 Mipmapping: Boolean): Boolean;

//---------------------------------------------------------------------------
procedure OGLDestroyTexture(var Texture: GLuint);

//---------------------------------------------------------------------------
function OGLDefineTexture2D(Width, Height: Integer;
 SurfaceBits: Pointer = nil): Boolean;

//---------------------------------------------------------------------------
procedure OGLGenerateTextureMipmaps();

//---------------------------------------------------------------------------
function OGLUpdateTextureContents(Texture, Width, Height: Integer;
 SurfaceBits: Pointer; Level: Integer = 0): Boolean;

//---------------------------------------------------------------------------
procedure OGLDisableTexture2D();

//---------------------------------------------------------------------------
function OGLCreateFrameBuffer(out FrameBuffer: GLuint;
 Texture: GLuint): Boolean;

//---------------------------------------------------------------------------
function OGLCreateDepthBuffer(Width, Height: Integer;

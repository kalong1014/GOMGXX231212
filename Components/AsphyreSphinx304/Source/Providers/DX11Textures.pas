unit DX11Textures;
//---------------------------------------------------------------------------
// DX11Textures.pas                                     Modified: 14-Sep-2012
// Direct3D 11 Texture implementation.                           Version 1.03
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX11Textures.pas.
//
...
//---------------------------------------------------------------------------
uses
 DXGI_JSB, D3D11_JSB, Types, AsphyreDef, AsphyreTypes, PixelSurfaces,
 AbstractTextures;
...
//---------------------------------------------------------------------------
uses
 Windows, SysUtils, AsphyreFPUStates, DX11Types, DX11Formats;
...
begin
 ...
 Pitch:= Surface.Pitch;
 Bits := Surface.GetPixelPtr(Rect.Left, Rect.Top);  //todo by glaciersoft    OLD: Bits := Surface.GetPixelPtr(Rect.Top, Rect.Left);
end;

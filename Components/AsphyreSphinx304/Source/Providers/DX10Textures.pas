unit DX10Textures;
//---------------------------------------------------------------------------
// DX10Textures.pas                                     Modified: 14-Sep-2012
// Direct3D 10.x texture implementation.                          Version 1.1
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX10Textures.pas.
//
...
//---------------------------------------------------------------------------
uses
 AsphyreDXGI, AsphyreD3D10, Types, SysUtils, AsphyreDef, AsphyreTypes,
 PixelSurfaces, AbstractTextures;
...
//---------------------------------------------------------------------------
uses
 Windows, AsphyreD3D10_1, AsphyreFPUStates, DX10Types, DX10Formats,
 AsphyreUtils, AsphyreConv;
...
begin
 ...
 Pitch:= Surface.Pitch;
 Bits := Surface.GetPixelPtr(Rect.Left, Rect.Top);
end;

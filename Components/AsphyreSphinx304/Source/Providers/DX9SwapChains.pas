unit DX9SwapChains;
//---------------------------------------------------------------------------
// DX9SwapChains.pas                                    Modified: 14-Sep-2012
// Direct3D 9 multiple swap chains implementation.               Version 1.11
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX9SwapChains.pas.
//
...
uses
 ...
 AsphyreTypes, AsphyreSwapChains;
...
//---------------------------------------------------------------------------
uses
 {$ifdef FireMonkey}FMX.Platform.Win,{$endif} SysUtils, DX9Types;
...
begin
 ...
 with FPresentParams do
  begin
   ...
   {$ifdef FireMonkey}
   hDeviceWindow:= FmxHandleToHWND(UserDesc.WindowHandle);
   {$else}

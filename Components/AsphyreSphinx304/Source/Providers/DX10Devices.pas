unit DX10Devices;
//---------------------------------------------------------------------------
// DX10Devices.pas                                      Modified: 14-Sep-2012
// Direct3D 10.x device management for Asphyre.                  Version 1.11
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX10Devices.pas.
//
...
//---------------------------------------------------------------------------
uses
 AsphyreDXGI, Classes, AbstractDevices, AbstractTextures, AsphyreSwapChains,
 DX10SwapChains;
...
//---------------------------------------------------------------------------
uses
 Windows, SysUtils, AsphyreD3D10, AsphyreD3D10_1, AsphyreFPUStates, DX10Types,
 AsphyreEvents;
...
begin
 // (1) Create factory object that will enumerate adapters (video cards).
 Result:= CreateFactory();
 if (not Result) then Exit;

 // (2) Create Direct3D interface.
 ...
 // (4) Update the window association for DXGI to stop monitoring its messages.

unit DX11SwapChains;
//---------------------------------------------------------------------------
// DX11SwapChains.pas                                   Modified: 14-Sep-2012
// DirectX 11 multiple swap chains implementation.               Version 1.02
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX11SwapChains.pas.
//
...
//---------------------------------------------------------------------------
uses
 DXGI_JSB, D3D11_JSB, AsphyreTypes, AsphyreSwapChains, Dialogs;
...
begin
 ...
 if (Result = DXGI_FORMAT_UNKNOWN) then Result:= DXGI_FORMAT_B8G8R8A8_UNORM;
end;

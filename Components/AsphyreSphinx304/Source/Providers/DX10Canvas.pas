unit DX10Canvas;
//---------------------------------------------------------------------------
// DX10Canvas.pas                                       Modified: 14-Sep-2012
// Direct3D 10.x canvas implementation.                           Version 1.1
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX10Canvas.pas.
//
...
//---------------------------------------------------------------------------
uses
 Windows, AsphyreD3D10, AsphyreD3D10_1, Types, SysUtils, AsphyreDef, Vectors2,
 AsphyreTypes, AsphyreUtils, AbstractTextures, AbstractCanvas,
 DX10CanvasEffects;
...
//--------------------------------------------------------------------------
uses
 Math, AsphyreDXGI, PixelUtils, AsphyreFPUStates, DX10Types, DX10CanvasEmbdFx;
...
//--------------------------------------------------------------------------
 DebugCanvasEffectFile = 'dx10canvas.fx';
...
//---------------------------------------------------------------------------
procedure TDX10Canvas.UseTexture(Texture: TAsphyreCustomTexture;

unit DX11Devices;
//---------------------------------------------------------------------------
// DX11Devices.pas                                      Modified: 14-Sep-2012
// DirectX 11 device management for Asphyre.                     Version 1.02
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is DX11Devices.pas.
//
...
//---------------------------------------------------------------------------
uses
 Classes, AbstractDevices, AbstractTextures, AsphyreSwapChains, DX11SwapChains;
...
//---------------------------------------------------------------------------
uses
 DXTypes_JSB, D3DCommon_JSB, DXGI_JSB, D3D11_JSB, Windows, SysUtils,
 AsphyreFPUStates, DX11Types, AsphyreEvents;

unit DX7Devices;
//---------------------------------------------------------------------------
// DX7Devices.pas                                       Modified: 14-Sep-2012
// DirectDraw + Direct3D devices using DirectX 7.0.              Version 1.06
//---------------------------------------------------------------------------
// Important Notice:
//
...
//---------------------------------------------------------------------------
uses
 Classes, AsphyreDDraw7, AsphyreD3D7, AbstractDevices, AsphyreSwapChains;
...
//---------------------------------------------------------------------------
uses
 Windows, SysUtils, DX7Types, AsphyreTypes, AsphyreEvents;

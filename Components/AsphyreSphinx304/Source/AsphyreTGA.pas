unit AsphyreTGA;
//---------------------------------------------------------------------------
// AsphyreTGA.pas                                       Modified: 14-Sep-2012
// Truevision TARGA format support for Asphyre.                  Version 1.22
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is AsphyreTGA.pas.
//
...
//---------------------------------------------------------------------------
uses
 Classes, SysUtils, AsphyreDef, SystemSurfaces, AsphyreBitmaps;

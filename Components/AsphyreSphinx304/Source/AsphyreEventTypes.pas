unit AsphyreEventTypes;
//---------------------------------------------------------------------------
// AsphyreEventTypes.pas                                Modified: 14-Sep-2012
// Asphyre Event System implementing observer pattern.           Version 1.01
//---------------------------------------------------------------------------
// Important Notice:
//
...
// under the License.
//
// The Original Code is AsphyreEventTypes.pas.
//
// The Initial Developer of the Original Code is Yuriy Kotsarenko.
// Portions created by Yuriy Kotsarenko are Copyright (C) 2010 - 2012,
...
{ Event callback function used by the majority of Asphyre events.
 ...
 TEventCallbackType = procedure(Sender: TObject; Param: Pointer;
...
{ Event subscription class implementing observer pattern. Recipient classes
 ...
 public
  ...
  function Subscribe(const AClassName: StdString;
   Callback: TEventCallbackType; Priority: Integer = -1): Integer;
  ...
  procedure Unsubscribe(EventId: Integer);
  ...
  function Notify(Sender: TObject; Param: Pointer = nil): Boolean;

  {@exclude}constructor Create(AOwner: TEventProviders);
...
//---------------------------------------------------------------------------
constructor TEventProvider.Create(AOwner: TEventProviders);
begin
 inherited Create();
...
//---------------------------------------------------------------------------
procedure TEventProvider.Unsubscribe(EventId: Integer);
var
 Index: Integer;
begin
...
//---------------------------------------------------------------------------
function TEventProvider.Notify(Sender: TObject; Param: Pointer = nil): Boolean;
var
 i: Integer;
 Allowed: Boolean;
begin
